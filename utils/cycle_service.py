...
def persist_cycle(
    ...
    """
    Persiste el ciclo completo en la BD (PostgreSQL local).
    ...
    return {
        "ok": True,
        "message": "Persistencia de ciclo completada en la BD.",
        "counts": {
...
def persist_cycle_to_supabase(
    ...
    return persist_cycle(df_ctas, df_cartera, df_cobranza, batch_size)
