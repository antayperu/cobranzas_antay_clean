...
ALL_POSSIBLE_COLS = [
    'COD CLIENTE', 'EMPRESA', 'COMPROBANTE', 'FECH EMIS', 'FECH VENC', 'DÍAS MORA',
    'MONEDA', 'MONT EMIT', 'TIPO CAMBIO', 'SALDO', 'DETRACCIÓN', 'ESTADO DETRACCION',
    'AMORTIZACIONES', 'SALDO REAL', 'ESTADO_EMAIL', 'FECHA_ULTIMO_ENVIO',
    'ESTADO_WHATSAPP', 'FECHA_ULTIMO_WA',
    'NOTA', 'CORREO', 'TELÉFONO', 'ENVIAR EMAIL', 'ESTADO DEUDA'
]
...
EXECUTIVE_COLS_DEFAULT = [
    ...
    'AMORTIZACIONES', 'SALDO REAL', 'ESTADO_EMAIL', 'FECHA_ULTIMO_ENVIO',
    'ESTADO_WHATSAPP', 'FECHA_ULTIMO_WA',
    'NOTA', 'CORREO', 'TELÉFONO', 'ENVIAR EMAIL'
]
